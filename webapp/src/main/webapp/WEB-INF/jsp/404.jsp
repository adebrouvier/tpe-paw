...
<div class="container center">
    ...
    <img src="<C:url value="/resources/img/error-404.png"/>" style="width: 250px; height: 150px">
    <p>
        <spring:message code="404.message"/></p>
    <a href="<c:url value = "/"/>" class="btn waves-effect waves-light light-blue darken-4"><spring:message
            code="404.return"/></a>
</div>
