                ...
                <div class="row tournament-tabs">
                    <div class="col s12">
                        <ul class="tabs">
                            ...
                            <li class="tab col s3"><a target="_self"
                                                      href="<c:url value="/tournament/${tournament.id}/comments"/>"><spring:message
                ...
                <div class="row">
                    <div class="col s12">
                        ...
                        <div class="tournament-container"
                             style="height:<c:out value="${roundSize*60+44}"/>px;overflow-y: hidden;overflow-x: auto;">
                            ...
                            <div class="tournament-col" style="left:<c:out value="${leftPosition}"/>;">
                                <c:choose>
                                    ...
                                    <c:when test="${roundSize != 1 && roundSize != 2}">
                                        <div class="round"><spring:message code="tournament.info.round"/> <c:out
                                                value="${roundCount}"/></div>
                                    </c:when>
                                </c:choose>
                                <c:choose>
                                                ...
                                                <div class="bracket">
                                                    <div class="players-name">
                                                        <div class="home-player-name">
                                                            ...
                                                            <c:if test="${match.homePlayerCharacter.length()!=null && match.homePlayerCharacter.length()+match.homePlayer.name.length()<14}"><c:out
                                                                    value=" (${match.homePlayerCharacter})"> </c:out></c:if>
                                                        </div>
                                                        <div class="away-player-name">
                                                            <c:out value="${match.awayPlayer.name}"/>
                                                            <c:if test="${match.awayPlayerCharacter.length()!=null && match.awayPlayerCharacter.length()+match.homePlayer.name.length()<14}"><c:out
                                                                    value=" (${match.awayPlayerCharacter})"> </c:out></c:if>
                                                        </div>
                                                    </div>
                                            ...
                                            <c:if test="${roundSize != 1}">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${matchCount % 2 != 0}">
                                                        <c:choose>
                                                            <c:when test="${matchCount == 1}">
                                                                <div class="match-left-branch"
                                                                     style="top:21px;height: <c:out
                                                                             value="${padding + 23}"/>px;"></div>
                                                                <div class="match-next-branch" style="top:<c:out
                                                                        value="${padding/2+43}"/>px"></div>
                                                            </c:when>
                                                            <c:when test="${matchCount != 1}">
                                                                <div class="match-left-branch" style="top:<c:out
                                                                        value="${padding + 21}"/>px;height: <c:out
                                                                        value="${padding + 23}"/>px;"></div>
                                                                <div class="match-next-branch" style="top:<c:out
                                                                        value="${padding/2+padding+43}"/>px"></div>
                                                            </c:when>
                                                        </c:choose>
                                                    </c:when>
                                                </c:choose>
                                        ...
                                        <c:choose>
                                            <c:when test="${loggedUser.id == tournament.creator.id && (match.awayPlayer.id != -1 && match.awayPlayer.id != 0 && match.homePlayer.id != 0 && tournament.status == 'STARTED')}">
                                                <div id="modal-${match.id}" class="modal match-modal">
                                                    ...
                                                    <form:form modelAttribute="matchForm" action="${postPath}"
                                                               method="post">
                                                            ...
                                                            <table class="modal-table centered">
                                                                ...
                                                                <tr class="modal-top-player">
                                                                    <td class="modal-player-name">
                                                                        <div><c:out
                                                                                value="${match.homePlayer.name}"/></div>
                                                                    </td>
                                                                    <td class="modal-player-score">
                                                                        <div class="input-field inline">
                                                                            <form:input id="home-result-${match.id}"
                                                                                        min="0" type="number"
                                                                                        cssClass="score-input"
                                                                                        path="homeResult"
                                                                                        value="${match.homePlayerScore}"/>
                                                                            <form:errors path="homeResult"
                                                                                         cssClass="formError"
                                                                                         element="p"/>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="modal-player-name">
                                                                        <div><c:out
                                                                                value="${match.awayPlayer.name}"/></div>
                                                                    </td>
                                                                    <td class="modal-player-score">
                                                                        <div class="input-field inline">
                                                                            <form:input min="0"
                                                                                        ...
                                                                                        cssClass="score-input"
                                                                                        path="awayResult"
                                                                                        value="${match.awayPlayerScore}"/>
                                                                            <form:errors path="awayResult"
                                                                                         cssClass="formError"
                                                                                         element="p"/>
                                                                        </div>
                                                                    </td>
                                                        ...
                                                        <div class="modal-footer">
                                                            <c:if test="${match.awayPlayer.id != -1}">
                                                                <a class="btn light-blue darken-4"
                                                                   href="<c:url value="/match/${tournament.id}/${match.id}"/>"><i
                                                                        class="material-icons right">edit</i>
                                                                    <spring:message code="match.edit.details"/></a>
                                                            </c:if>
                                            ...
                                            <c:otherwise>
                                                <div id="modal-${match.id}" class="modal match-modal">
                                                    <div class="modal-content">
                                                        <h5><spring:message
                                                                code="tournament.modal.title.otherUser"/></h5>
                                                        <table class="modal-table centered">
                                                            <tbody>
                                                            <tr class="modal-top-player">
                                                                <td class="modal-player-name">
                                                                    <c:choose>
                                                                        <c:when test="${match.homePlayer.id != null}">
                                                                            <div><c:out
                                                                                    value="${match.homePlayer.name}"/><c:if
                                                                                    test="${match.homePlayerCharacter!=null && (match.homePlayerCharacter.length()+match.homePlayer.name.length())<25}">(<c:out
                                                                                    value="${match.homePlayerCharacter}"/>)</c:if></div>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <div><spring:message
                                                                                    code="tournament.modal.tbd"/></div>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </td>
                                                                <td class="modal-player-score">
                                                                ...
                                                                <td class="modal-player-name">
                                                                    <c:choose>
                                                                        <c:when test="${match.awayPlayer.id != null}">
                                                                            <div><c:out
                                                                                    value="${match.awayPlayer.name}"/><c:if
                                                                                    test="${match.awayPlayerCharacter!=null && match.awayPlayerCharacter.length()+match.homePlayer.name.length()<25}">(<c:out
                                                                                    value="${match.awayPlayerCharacter}"/>)</c:if></div>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <div><spring:message
                                                                                    code="tournament.modal.tbd"/></div>
                                                        ...
                                                        <div class="row">
                                                            <c:if test="${match.map!=null}">
                                                                ...
                                                                <spring:message code="match.map"/>: <c:out
                                                                    value="${match.map}"/>
                                                            </c:if>
                                                        </div>
                                                        ...
                                                        <c:if test="${loggedUser.id == tournament.creator.id && match.awayPlayer.id != -1}">
                                                            <div class="row">
                                                                <a class="btn light-blue darken-4"
                                                                   href="<c:url value="/match/${tournament.id}/${match.id}"/>"><spring:message
                                                                        code="match.edit.details"/></a>
                                                            </div>
                                                        </c:if>
                                                    </div>
                                                </div>
