...
<main>
    <div class="section no-pad-bot" id="index-banner">
        <div class="container">
            ...
            <div class="row center">
                <a href="<c:url value = "/tournament"/>" class="btn-large waves-effect waves-light light-blue darken-4"><spring:message
                        code="index.header.tournament.button"/></a>
                <a href="<c:url value = "/ranking"/>"
                   class="btn-large waves-effect waves-light light-blue darken-4"><spring:message
                        code="index.header.ranking.button"/></a>
            </div>
            <br><br>
    ...
    <div class="featured container">
                    ...
                    <c:forEach var="winner" items="${topUsers}" varStatus="position">
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${rank == 1}">
                                        <img class="podium-trophy"
                                             src="<c:url value="/resources/img/gold-trophy.png"/>"/></c:when>
                                    <c:when test="${rank == 2}">
                                        <img class="podium-trophy"
                                             src="<c:url value="/resources/img/silver-trophy.png"/>"/> </c:when>
                                    <c:when test="${rank == 3}">
                                        <img class="podium-trophy"
                                             src="<c:url value="/resources/img/bronze-trophy.png"/>"/> </c:when>
                                    <c:otherwise>
                                        <span><c:out value="${rank}"/></span>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                            <td><a href="<c:url value="/user/${winner.user.id}"/>"><c:out
                                    value="${winner.user.name}"/></a></td>
            ...
            <div class="col s4">
                ...
                <table>
                    ...
                    <c:forEach var="popularUser" items="${mostFollowed}" varStatus="position">
                        <tr>
                            <td><a href="<c:url value="/user/${popularUser.user.id}"/>"><c:out
                                    value="${popularUser.user.name}"/></a></td>
            ...
            <div class="col s4">
                ...
                <table>
                    ...
                    <c:forEach var="popularRanking" items="${popularRankings}" varStatus="position">
                        <tr>
                            <td><a href="<c:url value="/ranking/${popularRanking.ranking.id}"/>"><c:out
                                    value="${popularRanking.ranking.name}"/></a></td>
        ...
        <table class="striped centered">
            ...
            <c:forEach var="tournament" items="${tournaments}">
                <tr>
                    <td><a href="<c:url value = "/tournament/${tournament.id}"/>"><c:out
                    ...
                    <td><a href="<c:url value = "/tournament/${tournament.id}"/>"><i class="material-icons black-text">info_outline</i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <table class="striped centered">
            ...
            <c:forEach var="ranking" items="${rankings}">
                <tr>
                    ...
                    <td><a href="<c:url value = "/ranking/${ranking.id}"/>"><i class="material-icons black-text">info_outline</i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
