    ...
    <div class="container center">
        ...
        <div class="row">
            <div class="col offset-s3 s6">
                ...
                <div class="row">
                    <div>
                        <ul id="tournament-format" class="dropdown-content">
                            <li><a href="#!"><spring:message code="tournament.create.singleelimination"/><span
                                    class="badge"></span></a></li>
                            <li><a href="#!"><spring:message code="tournament.create.doubleelimination"/><span
                                    class="badge"></span></a></li>
                            <li><a href="#!"><spring:message code="tournament.create.league"/></a></li>
                        </ul>
                        <a class="btn dropdown-button" href="#!" data-activates="tournament-format"><spring:message
                                code="tournament.create.format"
                        /><i
