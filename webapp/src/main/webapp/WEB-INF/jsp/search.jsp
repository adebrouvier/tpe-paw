        ...
        <div class="row">
            ...
            <form class="left" action="${getPath}" method="get">
                <div class="row valign-wrapper">
                    <div class="col s2 ">
                        <button class="btn light-blue darken-4" type="submit"><i class="tiny material-icons">search</i>
                        </button>
                    </div>
                    <div class="input-field col s5">
                        <spring:message code="index.search.placeholder" var="indexSearchPlaceholder"/>
                        <input id="search" class="typeahead" type="text" placeholder="${indexSearchPlaceholder}"
                        ...
                        <table>
                            ...
                            <c:forEach var="tournament" items="${tournamentResults}">
                                <tr>
                                    ...
                                    <td><a href="<c:url value = "/tournament/${tournament.id}"/>"><i
                                            class="material-icons black-text">info_outline</i></a></td>
                                </tr>
                            </c:forEach>
                    ...
                    <div class="card-content">
                        ...
                        <table id="ranking-results">
                            ...
                            <c:forEach var="ranking" items="${rankingResults}">
                                <tr>
                                    <td><a href="<c:url value = "/ranking/${ranking.id}"/>"><c:out
                                            value="${ranking.name}"/></a></td>
                                    <td><c:out value="${ranking.game.name}"/></td>
                                    <td><c:out value="${fn:length(ranking.userScores)}"/></td>
                                    <td><a href="<c:url value = "/ranking/${ranking.id}"/>"><i
                                            class="material-icons black-text">info_outline</i></a></td>
                                </tr>
                            </c:forEach>
