...
<head>
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/user-page.js"/>"></script>
        ...
        <div class="row s12 m12 l12">
            ...
            <div id="content-wrapper">
                <c:forEach var="tournament" items="${tournaments}">
                    <div class="col s8 m8 l8 right card card-style" id="content-wrapper">
                            ...
                            <p>
                                <c:forEach var="player" items="${tournament.players}">
                                    <c:if test="${player.user != null && player.user.id == user.id && player.standing != null}">
                                        <b><spring:message code="user.endPosition"/> #<c:out
                                                value="${player.standing}"/></b>
                                    </c:if>
                                    <c:if test="${player.user != null && player.user.id == user.id && player.standing == null}">
