        ...
        <div class="row s12 m12 l12">
            ...
            <div class="col s8 m8 l8 card">
                <div class="row tournament-tabs">
                    <div class="col s12">
                        <ul class="tabs">
                            <li class="tab col s6"><a class="active" href="#"><spring:message code="user.participates"/> </a></li>
                            <li class="tab col s6"><a target="_self" href="<c:url value="/user/${user.id}/creates"/>"><spring:message code="user.creates"/></a></li>
