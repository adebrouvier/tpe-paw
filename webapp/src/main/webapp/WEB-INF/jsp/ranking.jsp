                    ...
                    <div class="card-content">
                        ...
                        <form:form modelAttribute="rankingForm" action="${postPath}" method="post">
                            <div class="row">
                                <div class="col offset-s3 s6">
                                    <div class="input-field">
                                        <form:label path="rankingName"><spring:message code="ranking.create.name"/>:
                                        </form:label>
                                        <spring:message code="ranking.create.name.placeholder"
                                                        var="rankingNamePlaceholder"/>
                                        <form:input placeholder="${rankingNamePlaceholder}" type="text"
                                                    path="rankingName"
                                                    autocomplete="off"/>
                                    ...
                                    <div class="input-field">
                                        <form:label class="active" path="game"><spring:message
                                                code="ranking.create.game"/>: </form:label>
                                        <spring:message code="ranking.create.game.placeholder"
                                                        var="rankingGamePlaceholder"/>
                                        <form:input id="game-search" placeholder="${rankingGamePlaceholder}" type="text"
                                                    cssClass="typeahead"
                            ...
                            <button class="btn btn-primary light-blue darken-4" type="submit"><spring:message
                                    code="ranking.create.submit"/></button>
                        </form:form>
                    </div>
                </div>
            </div>
