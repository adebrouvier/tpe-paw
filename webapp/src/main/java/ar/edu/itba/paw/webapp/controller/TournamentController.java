...
public class TournamentController {
    ...
    @RequestMapping(value = "/tournament/{tournamentId}/{playerId}/removePlayers", method = {RequestMethod.POST})
    public ModelAndView removePlayer(@Valid @ModelAttribute("playerForm") final MatchForm form, final BindingResult errors, @PathVariable long tournamentId, @PathVariable int playerId) {
        if (errors.hasErrors()) {
            return tournament(form,tournamentId);
        }
        ps.removeFromTournament(playerId, tournamentId);
