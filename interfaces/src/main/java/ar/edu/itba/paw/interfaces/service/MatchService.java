...
public interface MatchService {
    ...
    public Match addPlayer(final long tournamentId, final int matchId, final long playerId, final Integer type);
    public Match updateScore(final long tournamentId, final int matchId, final Integer homeScore, final Integer awayScore);
}
