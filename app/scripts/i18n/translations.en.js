...
define([], function () {
  ...
  return {
    ...
    USER_EDIT_PROFILE: 'Edit your profile by clicking on the pencil!',
    ...
    USER_TWITCH_SIZE: 'Twitch url must be between at most 100 characters long.',
    USER_TWITTER_SIZE: 'Twitter url must be between at most 100 characters long.',
    USER_YOUTUBE_SIZE: 'Youtube url must be between at mot 100 characters long.',
    USER_GAME_SIZE: 'Game must be between at most 60 characters long.',
    USER_PARTICIPATES_EMPTY: 'User has not participated on any tournament.',
    USER_CREATED_EMPTY: 'User has not created any tournaments or rankings.',
    USER_RANKING_EMPTY: 'User does not belong to any ranking.',
