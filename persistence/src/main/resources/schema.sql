...
ALTER TABLE users
  ADD COLUMN IF NOT EXISTS twitch_url VARCHAR(2000);
ALTER TABLE users
  ADD COLUMN IF NOT EXISTS twitter_url VARCHAR(2000);
ALTER TABLE users
  ADD COLUMN IF NOT EXISTS youtube_url VARCHAR(2000);
...
ALTER TABLE match
  ADD COLUMN IF NOT EXISTS home_player_character VARCHAR(2000);
ALTER TABLE match
  ADD COLUMN IF NOT EXISTS away_player_character VARCHAR(2000);
ALTER TABLE match
  ADD COLUMN IF NOT EXISTS vod_link VARCHAR(2000);
