...
public class UserHibernateDao implements UserDao {
    ...
    public List<MostFollowedDTO> findMostFollowed(int userCount) {
        ...
        final TypedQuery<MostFollowedDTO> query = em.createQuery("select new ar.edu.itba.paw.model.MostFollowedDTO(u.userFollowed, count(*)) from UserFollow as u group by u.userFollowed", MostFollowedDTO.class)
